export const Rules = [
    ...
    },
    {
        ...
        time: 'take no time',
        content:
            '<p>Only psionicists may make psionic attacks. A special procedure is used:</p><ul><li><strong>(1):</strong> Choose the size of the attack, from 1 to 6, and select one person as the target.</li><li><strong>(2):</strong> Roll 1d6. If the roll equals or exceeds the attack size, you inflict a number of hits to the target equal to the size of the attack. If the roll is less than the size of the attack, the attacker takes a number of hits equal to the die roll. For wound effects, see <strong>R231</strong>.</li><li><strong>(3):</strong> The size of the attack is limited by the Psionic Power of the attacker. The total of all attack strengths made during a day cannot exceed the psionic power of the individual. Special Abilities: A psionicist can use his/her power points as defense against psionic attacks, on a non-psionic person, but not a psionic person. Each point of power used in defense protects one person for one round.</li></ul>',
    },
    {
        id: 'E023',
        title: 'Go to Jail',
    ...
    },
    {
        ...
        time: 'takes 1 hour',
        content:
            '<p>You see debris scattered in space and an activated stasis unit of 4 CU size. If you take the unit, when (and if) you deactivate it, roll 1d6 and refer to the appropriate event:</p><ul><li>1 - E400</li><li>2 - E405</li><li>3 - E410</li><li>4 - E415</li><li>5 - E420</li><li>6 - E425</li></ul>',
    },
    {
        id: 'E104',
        title: 'Not Detected',
    ...
    },
    {
        ...
        time: '1 hour/round',
        content:
            '<p>The merchant ship will stand and fight, but will not pursue if you try to escape. When the merchant has suffered eleven hits (is within one of destruction) it will surrender and submit to boarding. You can board if you have someone to leave behind to man the starship guns on your ship. Otherwise you cannot board and the event ends.</p><p>If you board, you discover you can loot the merchant, but the captain and his loyal crew threaten self-destruct if you do anything else. If you loot the ship you’ll be “wanted” in this system, roll 1d6 for the result:</p><ul><li>1 - ship is empty, captain is nearly bankrupt</li><li>2 - find 30 CU of platinum ore concentrate, worth 800 S base price (R229A) at any Industrial area</li><li>3 - find 64 dead slaves — their life support failed during the battle, they are now worthless, but you won’t be “wanted” due to your piracy (slavers don’t complain to authorities!)</li><li>4 - find six luxury skimmers, each 10 CU, you can sell one per City or Gambling area if you roll 1d6 and get 5-6 for a base price (R229A) of 400 S, each sales attempt takes 1 hour, no more than one attempt per day in an area</li><li>5 - find 50 CU of luxury candies worth 200 S per CU at any palace, and a 2 CU unit of Vegan pomset oil (see below)</li><li>6 - find 44 U-type robots (R222) that are all broken-down (R218)</li></ul><p><b>Vegan Pomset Oil:</b> collected from the glands of the Vegan pomset, a highly intelligent forest-dweller under protection from exploitation. The oil is illegal in every system of this sector, with a 30,000 S fine to anyone caught with it by any authorities (plus confiscation of the oil). However, the oil may be sold at a Space Station or Scientific area for a base price of 18,000 S per CU.</p>',
    },
    {
        id: 'E180',
        title: 'Food Markets',
